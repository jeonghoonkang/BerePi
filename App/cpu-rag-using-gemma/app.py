"""Streamlit app for local LLM RAG pipeline on CPU.
...
All model execution is forced onto the CPU so the application can run on hosts without a GPU.
"""
...
if model_path and st.session_state.llm is None:
    try:
        ...
        st.success("LLM loaded successfully (CPU mode)")
