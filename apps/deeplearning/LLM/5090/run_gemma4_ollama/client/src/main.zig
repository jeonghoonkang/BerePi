...
const dev_origins = [_][]const u8{ "zero://app", "zero://inline", "http://127.0.0.1:5173", "http://127.0.0.1:8765" };

pub fn main(init: std.process.Init) !void {
    var app = App{ .env_map = init.environ_map };
    try runner.runWithOptions(app.app(), .{
        .app_name = "Gemma4 Prompt Client",
        .window_title = "Gemma4 Prompt Client",
        .bundle_id = "com.berepi.gemma4promptclient",
        .icon_path = "",
        .security = .{
