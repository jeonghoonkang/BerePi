...
검사 중에는 현재 페이지, 경과 시간, 남은 시간과 예상 종료 시각이 실시간 표시됩니다. 첫 페이지가 끝난 뒤부터 실제 누적 평균 처리 속도를 기준으로 예상 시간이 계속 보정됩니다.

```text
맞춤법 검사 중: 15/313 페이지 | 경과 00:02:14 | 남은 시간 00:44:55 | 예상 종료 2026-08-31 18:30:10
```
