...
- IoT big data collection and analytics software toolkit based on RaspberryPi IoT level computing system
...
- supports Raspbian Buster (ver 2019.09.12), with RaspBerryPi3 (input hangul mode, 한글모드)
